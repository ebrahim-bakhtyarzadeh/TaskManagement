...
{
	 public class CreateTaskCommand : TaskCommand, IRequest<UseCaseResult>
	 {

		  public class CreateTaskCommandHandler : IRequestHandler<CreateTaskCommand, UseCaseResult>
		  {
			   ...
			   public async Task<UseCaseResult> Handle(CreateTaskCommand request, CancellationToken cancellationToken)
			   {
					try
					{
						 WorkItem workItem;
						 ...
						 return UseCaseResult.Success("ثبت وظیفه با موفقیت انجام شد");
					}
					catch
					{
